...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_layout_transform_reshape_divide_round_clip(float* p0, float* compute, uint8_t* global_const_workspace_24_var, uint8_t* global_workspace_25_var) {
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_avg_pool2d_divide_round_clip_multiply(float* p0, float* T_multiply, uint8_t* global_const_workspace_22_var, uint8_t* global_workspace_23_var) {
  void* pool_sum_let = (&(global_workspace_23_var[16384]));
  ...
  for (int32_t ax0_ax1_fused = 0; ax0_ax1_fused < 16; ++ax0_ax1_fused) {
    for (int32_t ax4_1 = 0; ax4_1 < 4; ++ax4_1) {
      ...
      float v_ = roundf(((((float*)pool_sum_let)[cse_var_2] * 1.562500e-02f) * 3.919435e+00f));
      float v__1 = (v_) < (1.270000e+02f) ? (v_) : (1.270000e+02f);
      T_multiply[cse_var_2] = (((v__1) > (-1.280000e+02f) ? (v__1) : (-1.280000e+02f)) * 2.551388e-01f);
    }
  }
  return 0;
}
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_dense_pack_add_divide_round_clip_multiply(float* p0, float* T_multiply, uint8_t* global_const_workspace_26_var, uint8_t* global_workspace_27_var) {
  void* fused_nn_contrib_dense_pack_constant_let = (&(global_const_workspace_26_var[310784]));
  void* fused_constant_9_let = (&(global_const_workspace_26_var[303104]));
  for (int32_t ax1_outer_ax0_outer_fused = 0; ax1_outer_ax0_outer_fused < 2; ++ax1_outer_ax0_outer_fused) {
    void* compute_let = (&(global_workspace_27_var[336]));
    void* compute_global_let = (&(global_workspace_27_var[304]));
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_softmax(float* p0, float* T_softmax_norm, uint8_t* global_const_workspace_28_var, uint8_t* global_workspace_29_var) {
  void* T_softmax_maxelem_let = (&(global_workspace_29_var[48]));
  ...
  void* T_softmax_exp_let = (&(global_workspace_29_var[0]));
  for (int32_t i1 = 0; i1 < 10; ++i1) {
    ((float*)T_softmax_exp_let)[i1] = expf((p0[i1] - ((float*)T_softmax_maxelem_let)[0]));
  }
  void* T_softmax_expsum_let = (&(global_workspace_29_var[48]));
...
TVM_DLL int32_t tvmgen_default___tvm_main__(float* input_1_buffer_var, float* output_buffer_var, uint8_t* global_const_workspace_0_var, uint8_t* global_workspace_1_var) {
  ...
  void* sid_11_let = (&(global_workspace_1_var[256]));
  ...
  void* sid_13_let = (&(global_workspace_1_var[256]));
  ...
  if (tvmgen_default_fused_nn_avg_pool2d_divide_round_clip_multiply(sid_10_let, sid_11_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_layout_transform_reshape_divide_round_clip(sid_11_let, sid_12_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_nn_contrib_dense_pack_add_divide_round_clip_multiply(sid_12_let, sid_13_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_nn_softmax(sid_13_let, output_buffer_var, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  return 0;
}
