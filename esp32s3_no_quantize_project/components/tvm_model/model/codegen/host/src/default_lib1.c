...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_layout_transform_reshape(float* p0, float* T_reshape, uint8_t* global_const_workspace_26_var, uint8_t* global_workspace_27_var) {
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_avg_pool2d(float* p0, float* pool_avg, uint8_t* global_const_workspace_24_var, uint8_t* global_workspace_25_var) {
  ...
  for (int32_t ax3_1 = 0; ax3_1 < 64; ++ax3_1) {
    pool_avg[ax3_1] = (((float*)pool_sum_let)[ax3_1] * 1.562500e-02f);
  }
  return 0;
}
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add(float* p0, float* T_add, uint8_t* global_const_workspace_12_var, uint8_t* global_workspace_13_var) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused = 0; ax0_ax1_fused_ax2_fused < 128; ++ax0_ax1_fused_ax2_fused) {
    ...
    for (int32_t ax3_inner = 0; ax3_inner < 16; ++ax3_inner) {
      for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
        ...
        T_add[(((ax0_ax1_fused_ax2_fused * 64) + cse_var_19) + ax4)] = (((float*)conv2d_NCHWc_let)[(cse_var_19 + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_4_let)[(((ax0_ax1_fused_ax2_fused >> 4) * 4) + ax4)]);
      }
    }
  }
  return 0;
  ...
  for (int32_t ax0_ax1_fused_ax2_fused = 0; ax0_ax1_fused_ax2_fused < 128; ++ax0_ax1_fused_ax2_fused) {
    ...
    for (int32_t ax3_inner = 0; ax3_inner < 8; ++ax3_inner) {
      for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
        ...
        T_add[(((ax0_ax1_fused_ax2_fused * 32) + cse_var_11) + ax4)] = (((float*)conv2d_NCHWc_let)[(cse_var_11 + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_7_let)[(((ax0_ax1_fused_ax2_fused >> 3) * 4) + ax4)]);
      }
    }
  }
  return 0;
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_add_nn_relu(float* p0, float* p1, float* T_relu, uint8_t* global_const_workspace_8_var, uint8_t* global_workspace_9_var) {
      ...
      for (int32_t ic_outer = 0; ic_outer < 4; ++ic_outer) {
        for (int32_t kh = 0; kh < 3; ++kh) {
          for (int32_t kw = 0; kw < 3; ++kw) {
            for (int32_t ic_inner = 0; ic_inner < 4; ++ic_inner) {
              for (int32_t oc_block_c = 0; oc_block_c < 4; ++oc_block_c) {
                ((float*)conv2d_NCHWc_global_let)[oc_block_c] = (((float*)conv2d_NCHWc_global_let)[oc_block_c] + (((float*)data_pad_let)[((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c)]));
              }
              for (int32_t oc_block_c_1 = 0; oc_block_c_1 < 4; ++oc_block_c_1) {
                int32_t cse_var_3 = (oc_block_c_1 + 4);
                ((float*)conv2d_NCHWc_global_let)[cse_var_3] = (((float*)conv2d_NCHWc_global_let)[cse_var_3] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 4)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_1)]));
              }
              for (int32_t oc_block_c_2 = 0; oc_block_c_2 < 4; ++oc_block_c_2) {
                int32_t cse_var_4 = (oc_block_c_2 + 8);
                ((float*)conv2d_NCHWc_global_let)[cse_var_4] = (((float*)conv2d_NCHWc_global_let)[cse_var_4] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 8)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_2)]));
              }
              for (int32_t oc_block_c_3 = 0; oc_block_c_3 < 4; ++oc_block_c_3) {
                int32_t cse_var_5 = (oc_block_c_3 + 12);
                ((float*)conv2d_NCHWc_global_let)[cse_var_5] = (((float*)conv2d_NCHWc_global_let)[cse_var_5] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 12)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_3)]));
              }
              for (int32_t oc_block_c_4 = 0; oc_block_c_4 < 4; ++oc_block_c_4) {
                int32_t cse_var_6 = (oc_block_c_4 + 16);
                ((float*)conv2d_NCHWc_global_let)[cse_var_6] = (((float*)conv2d_NCHWc_global_let)[cse_var_6] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 16)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_4)]));
              }
              for (int32_t oc_block_c_5 = 0; oc_block_c_5 < 4; ++oc_block_c_5) {
                int32_t cse_var_7 = (oc_block_c_5 + 20);
                ((float*)conv2d_NCHWc_global_let)[cse_var_7] = (((float*)conv2d_NCHWc_global_let)[cse_var_7] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 20)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_5)]));
              }
              for (int32_t oc_block_c_6 = 0; oc_block_c_6 < 4; ++oc_block_c_6) {
                int32_t cse_var_8 = (oc_block_c_6 + 24);
                ((float*)conv2d_NCHWc_global_let)[cse_var_8] = (((float*)conv2d_NCHWc_global_let)[cse_var_8] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 24)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_6)]));
              }
              for (int32_t oc_block_c_7 = 0; oc_block_c_7 < 4; ++oc_block_c_7) {
                int32_t cse_var_9 = (oc_block_c_7 + 28);
                ((float*)conv2d_NCHWc_global_let)[cse_var_9] = (((float*)conv2d_NCHWc_global_let)[cse_var_9] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 28)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_7)]));
              }
              for (int32_t oc_block_c_8 = 0; oc_block_c_8 < 4; ++oc_block_c_8) {
                int32_t cse_var_10 = (oc_block_c_8 + 32);
                ((float*)conv2d_NCHWc_global_let)[cse_var_10] = (((float*)conv2d_NCHWc_global_let)[cse_var_10] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 32)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_8)]));
              }
              for (int32_t oc_block_c_9 = 0; oc_block_c_9 < 4; ++oc_block_c_9) {
                int32_t cse_var_11 = (oc_block_c_9 + 36);
                ((float*)conv2d_NCHWc_global_let)[cse_var_11] = (((float*)conv2d_NCHWc_global_let)[cse_var_11] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 36)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_9)]));
              }
              for (int32_t oc_block_c_10 = 0; oc_block_c_10 < 4; ++oc_block_c_10) {
                int32_t cse_var_12 = (oc_block_c_10 + 40);
                ((float*)conv2d_NCHWc_global_let)[cse_var_12] = (((float*)conv2d_NCHWc_global_let)[cse_var_12] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 40)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_10)]));
              }
              for (int32_t oc_block_c_11 = 0; oc_block_c_11 < 4; ++oc_block_c_11) {
                int32_t cse_var_13 = (oc_block_c_11 + 44);
                ((float*)conv2d_NCHWc_global_let)[cse_var_13] = (((float*)conv2d_NCHWc_global_let)[cse_var_13] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 44)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_11)]));
              }
              for (int32_t oc_block_c_12 = 0; oc_block_c_12 < 4; ++oc_block_c_12) {
                int32_t cse_var_14 = (oc_block_c_12 + 48);
                ((float*)conv2d_NCHWc_global_let)[cse_var_14] = (((float*)conv2d_NCHWc_global_let)[cse_var_14] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 48)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_12)]));
              }
              for (int32_t oc_block_c_13 = 0; oc_block_c_13 < 4; ++oc_block_c_13) {
                int32_t cse_var_15 = (oc_block_c_13 + 52);
                ((float*)conv2d_NCHWc_global_let)[cse_var_15] = (((float*)conv2d_NCHWc_global_let)[cse_var_15] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 52)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_13)]));
              }
              for (int32_t oc_block_c_14 = 0; oc_block_c_14 < 4; ++oc_block_c_14) {
                int32_t cse_var_16 = (oc_block_c_14 + 56);
                ((float*)conv2d_NCHWc_global_let)[cse_var_16] = (((float*)conv2d_NCHWc_global_let)[cse_var_16] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 56)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_14)]));
              }
              for (int32_t oc_block_c_15 = 0; oc_block_c_15 < 4; ++oc_block_c_15) {
                int32_t cse_var_17 = (oc_block_c_15 + 60);
                ((float*)conv2d_NCHWc_global_let)[cse_var_17] = (((float*)conv2d_NCHWc_global_let)[cse_var_17] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 60)] * ((float*)fused_constant_2_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_15)]));
              }
            }
          }
        }
    ...
    for (int32_t ax3_outer = 0; ax3_outer < 2; ++ax3_outer) {
      for (int32_t ax3_inner = 0; ax3_inner < 16; ++ax3_inner) {
        for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
          ...
          float v_ = p1[cse_var_19] + (((float*)conv2d_NCHWc_let)[((cse_var_21 + cse_var_20) + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_2_let)[(((ax0_ax1_fused_ax2_fused >> 5) * 4) + ax4)]);
          T_relu[cse_var_19] = ((v_) > (0.000000e+00f) ? (v_) : (0.000000e+00f));
        }
      }
    }
  }
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_add_nn_relu_1(float* p0, float* p1, float* T_relu, uint8_t* global_const_workspace_14_var, uint8_t* global_workspace_15_var) {
  ...
  for (int32_t ax0_ax1_fused_ax2_outer_fused = 0; ax0_ax1_fused_ax2_outer_fused < 128; ++ax0_ax1_fused_ax2_outer_fused) {
    ...
    for (int32_t ic_outer = 0; ic_outer < 4; ++ic_outer) {
      for (int32_t ic_inner = 0; ic_inner < 4; ++ic_inner) {
        for (int32_t oc_block_c = 0; oc_block_c < 4; ++oc_block_c) {
          ((float*)conv2d_NCHWc_global_let)[oc_block_c] = (((float*)conv2d_NCHWc_global_let)[oc_block_c] + (p0[(((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c)]));
        }
        for (int32_t oc_block_c_1 = 0; oc_block_c_1 < 4; ++oc_block_c_1) {
          int32_t cse_var_1 = (oc_block_c_1 + 4);
          ((float*)conv2d_NCHWc_global_let)[cse_var_1] = (((float*)conv2d_NCHWc_global_let)[cse_var_1] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 8)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_1)]));
        }
        for (int32_t oc_block_c_2 = 0; oc_block_c_2 < 4; ++oc_block_c_2) {
          int32_t cse_var_2 = (oc_block_c_2 + 8);
          ((float*)conv2d_NCHWc_global_let)[cse_var_2] = (((float*)conv2d_NCHWc_global_let)[cse_var_2] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 16)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_2)]));
        }
        for (int32_t oc_block_c_3 = 0; oc_block_c_3 < 4; ++oc_block_c_3) {
          int32_t cse_var_3 = (oc_block_c_3 + 12);
          ((float*)conv2d_NCHWc_global_let)[cse_var_3] = (((float*)conv2d_NCHWc_global_let)[cse_var_3] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 24)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_3)]));
        }
        for (int32_t oc_block_c_4 = 0; oc_block_c_4 < 4; ++oc_block_c_4) {
          int32_t cse_var_4 = (oc_block_c_4 + 16);
          ((float*)conv2d_NCHWc_global_let)[cse_var_4] = (((float*)conv2d_NCHWc_global_let)[cse_var_4] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 32)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_4)]));
        }
        for (int32_t oc_block_c_5 = 0; oc_block_c_5 < 4; ++oc_block_c_5) {
          int32_t cse_var_5 = (oc_block_c_5 + 20);
          ((float*)conv2d_NCHWc_global_let)[cse_var_5] = (((float*)conv2d_NCHWc_global_let)[cse_var_5] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 40)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_5)]));
        }
        for (int32_t oc_block_c_6 = 0; oc_block_c_6 < 4; ++oc_block_c_6) {
          int32_t cse_var_6 = (oc_block_c_6 + 24);
          ((float*)conv2d_NCHWc_global_let)[cse_var_6] = (((float*)conv2d_NCHWc_global_let)[cse_var_6] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 48)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_6)]));
        }
        for (int32_t oc_block_c_7 = 0; oc_block_c_7 < 4; ++oc_block_c_7) {
          int32_t cse_var_7 = (oc_block_c_7 + 28);
          ((float*)conv2d_NCHWc_global_let)[cse_var_7] = (((float*)conv2d_NCHWc_global_let)[cse_var_7] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 56)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_7)]));
        }
        for (int32_t oc_block_c_8 = 0; oc_block_c_8 < 4; ++oc_block_c_8) {
          int32_t cse_var_8 = (oc_block_c_8 + 32);
          ((float*)conv2d_NCHWc_global_let)[cse_var_8] = (((float*)conv2d_NCHWc_global_let)[cse_var_8] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 64)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_8)]));
        }
        for (int32_t oc_block_c_9 = 0; oc_block_c_9 < 4; ++oc_block_c_9) {
          int32_t cse_var_9 = (oc_block_c_9 + 36);
          ((float*)conv2d_NCHWc_global_let)[cse_var_9] = (((float*)conv2d_NCHWc_global_let)[cse_var_9] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 72)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_9)]));
        }
        for (int32_t oc_block_c_10 = 0; oc_block_c_10 < 4; ++oc_block_c_10) {
          int32_t cse_var_10 = (oc_block_c_10 + 40);
          ((float*)conv2d_NCHWc_global_let)[cse_var_10] = (((float*)conv2d_NCHWc_global_let)[cse_var_10] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 80)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_10)]));
        }
        for (int32_t oc_block_c_11 = 0; oc_block_c_11 < 4; ++oc_block_c_11) {
          int32_t cse_var_11 = (oc_block_c_11 + 44);
          ((float*)conv2d_NCHWc_global_let)[cse_var_11] = (((float*)conv2d_NCHWc_global_let)[cse_var_11] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 88)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_11)]));
        }
        for (int32_t oc_block_c_12 = 0; oc_block_c_12 < 4; ++oc_block_c_12) {
          int32_t cse_var_12 = (oc_block_c_12 + 48);
          ((float*)conv2d_NCHWc_global_let)[cse_var_12] = (((float*)conv2d_NCHWc_global_let)[cse_var_12] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 96)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_12)]));
        }
        for (int32_t oc_block_c_13 = 0; oc_block_c_13 < 4; ++oc_block_c_13) {
          int32_t cse_var_13 = (oc_block_c_13 + 52);
          ((float*)conv2d_NCHWc_global_let)[cse_var_13] = (((float*)conv2d_NCHWc_global_let)[cse_var_13] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 104)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_13)]));
        }
        for (int32_t oc_block_c_14 = 0; oc_block_c_14 < 4; ++oc_block_c_14) {
          int32_t cse_var_14 = (oc_block_c_14 + 56);
          ((float*)conv2d_NCHWc_global_let)[cse_var_14] = (((float*)conv2d_NCHWc_global_let)[cse_var_14] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 112)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_14)]));
        }
        for (int32_t oc_block_c_15 = 0; oc_block_c_15 < 4; ++oc_block_c_15) {
          int32_t cse_var_15 = (oc_block_c_15 + 60);
          ((float*)conv2d_NCHWc_global_let)[cse_var_15] = (((float*)conv2d_NCHWc_global_let)[cse_var_15] + (p0[((((ic_outer * 4096) + ((ax0_ax1_fused_ax2_outer_fused & 15) * 256)) + ic_inner) + 120)] * ((float*)fused_constant_5_let)[(((((ax0_ax1_fused_ax2_outer_fused >> 4) * 64) + (ic_outer * 16)) + (ic_inner * 4)) + oc_block_c_15)]));
        }
      }
    }
    for (int32_t ow_inner = 0; ow_inner < 16; ++ow_inner) {
    ...
    for (int32_t ax3_inner = 0; ax3_inner < 16; ++ax3_inner) {
      for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
        ...
        float v_ = (((float*)conv2d_NCHWc_let)[(cse_var_18 + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_5_let)[(((ax0_ax1_fused_ax2_outer_fused >> 4) * 4) + ax4)]) + p1[cse_var_17];
        T_relu[cse_var_17] = ((v_) > (0.000000e+00f) ? (v_) : (0.000000e+00f));
      }
    }
  }
  return 0;
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_add_nn_relu_2(float* p0, float* p1, float* T_relu, uint8_t* global_const_workspace_20_var, uint8_t* global_workspace_21_var) {
    ...
    for (int32_t ax2_inner = 0; ax2_inner < 2; ++ax2_inner) {
      for (int32_t ax3_inner = 0; ax3_inner < 8; ++ax3_inner) {
        for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
          ...
          float v_ = (((float*)conv2d_NCHWc_let)[((cse_var_19 + cse_var_18) + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_8_let)[(((ax0_ax1_fused_ax2_outer_fused >> 2) * 4) + ax4)]) + p1[cse_var_17];
          T_relu[cse_var_17] = ((v_) > (0.000000e+00f) ? (v_) : (0.000000e+00f));
        }
      }
    }
    ...
    for (int32_t ax3_outer = 0; ax3_outer < 2; ++ax3_outer) {
      for (int32_t ax3_inner = 0; ax3_inner < 16; ++ax3_inner) {
        for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
          ...
          int32_t cse_var_18 = (ax3_inner * 4);
          float v_ = ((float*)conv2d_NCHWc_let)[((cse_var_19 + cse_var_18) + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_let)[(((ax0_ax1_fused_ax2_fused >> 5) * 4) + ax4)];
          T_relu[((((ax0_ax1_fused_ax2_fused * 128) + cse_var_19) + cse_var_18) + ax4)] = ((v_) > (0.000000e+00f) ? (v_) : (0.000000e+00f));
        }
      }
    }
  }
      ...
      for (int32_t ic_outer = 0; ic_outer < 4; ++ic_outer) {
        for (int32_t kh = 0; kh < 3; ++kh) {
          for (int32_t kw = 0; kw < 3; ++kw) {
            for (int32_t ic_inner = 0; ic_inner < 4; ++ic_inner) {
              for (int32_t oc_block_c = 0; oc_block_c < 4; ++oc_block_c) {
                ((float*)conv2d_NCHWc_global_let)[oc_block_c] = (((float*)conv2d_NCHWc_global_let)[oc_block_c] + (((float*)data_pad_let)[((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c)]));
              }
              for (int32_t oc_block_c_1 = 0; oc_block_c_1 < 4; ++oc_block_c_1) {
                int32_t cse_var_3 = (oc_block_c_1 + 4);
                ((float*)conv2d_NCHWc_global_let)[cse_var_3] = (((float*)conv2d_NCHWc_global_let)[cse_var_3] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 4)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_1)]));
              }
              for (int32_t oc_block_c_2 = 0; oc_block_c_2 < 4; ++oc_block_c_2) {
                int32_t cse_var_4 = (oc_block_c_2 + 8);
                ((float*)conv2d_NCHWc_global_let)[cse_var_4] = (((float*)conv2d_NCHWc_global_let)[cse_var_4] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 8)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_2)]));
              }
              for (int32_t oc_block_c_3 = 0; oc_block_c_3 < 4; ++oc_block_c_3) {
                int32_t cse_var_5 = (oc_block_c_3 + 12);
                ((float*)conv2d_NCHWc_global_let)[cse_var_5] = (((float*)conv2d_NCHWc_global_let)[cse_var_5] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 12)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_3)]));
              }
              for (int32_t oc_block_c_4 = 0; oc_block_c_4 < 4; ++oc_block_c_4) {
                int32_t cse_var_6 = (oc_block_c_4 + 16);
                ((float*)conv2d_NCHWc_global_let)[cse_var_6] = (((float*)conv2d_NCHWc_global_let)[cse_var_6] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 16)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_4)]));
              }
              for (int32_t oc_block_c_5 = 0; oc_block_c_5 < 4; ++oc_block_c_5) {
                int32_t cse_var_7 = (oc_block_c_5 + 20);
                ((float*)conv2d_NCHWc_global_let)[cse_var_7] = (((float*)conv2d_NCHWc_global_let)[cse_var_7] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 20)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_5)]));
              }
              for (int32_t oc_block_c_6 = 0; oc_block_c_6 < 4; ++oc_block_c_6) {
                int32_t cse_var_8 = (oc_block_c_6 + 24);
                ((float*)conv2d_NCHWc_global_let)[cse_var_8] = (((float*)conv2d_NCHWc_global_let)[cse_var_8] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 24)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_6)]));
              }
              for (int32_t oc_block_c_7 = 0; oc_block_c_7 < 4; ++oc_block_c_7) {
                int32_t cse_var_9 = (oc_block_c_7 + 28);
                ((float*)conv2d_NCHWc_global_let)[cse_var_9] = (((float*)conv2d_NCHWc_global_let)[cse_var_9] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 28)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_7)]));
              }
              for (int32_t oc_block_c_8 = 0; oc_block_c_8 < 4; ++oc_block_c_8) {
                int32_t cse_var_10 = (oc_block_c_8 + 32);
                ((float*)conv2d_NCHWc_global_let)[cse_var_10] = (((float*)conv2d_NCHWc_global_let)[cse_var_10] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 32)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_8)]));
              }
              for (int32_t oc_block_c_9 = 0; oc_block_c_9 < 4; ++oc_block_c_9) {
                int32_t cse_var_11 = (oc_block_c_9 + 36);
                ((float*)conv2d_NCHWc_global_let)[cse_var_11] = (((float*)conv2d_NCHWc_global_let)[cse_var_11] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 36)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_9)]));
              }
              for (int32_t oc_block_c_10 = 0; oc_block_c_10 < 4; ++oc_block_c_10) {
                int32_t cse_var_12 = (oc_block_c_10 + 40);
                ((float*)conv2d_NCHWc_global_let)[cse_var_12] = (((float*)conv2d_NCHWc_global_let)[cse_var_12] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 40)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_10)]));
              }
              for (int32_t oc_block_c_11 = 0; oc_block_c_11 < 4; ++oc_block_c_11) {
                int32_t cse_var_13 = (oc_block_c_11 + 44);
                ((float*)conv2d_NCHWc_global_let)[cse_var_13] = (((float*)conv2d_NCHWc_global_let)[cse_var_13] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 44)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_11)]));
              }
              for (int32_t oc_block_c_12 = 0; oc_block_c_12 < 4; ++oc_block_c_12) {
                int32_t cse_var_14 = (oc_block_c_12 + 48);
                ((float*)conv2d_NCHWc_global_let)[cse_var_14] = (((float*)conv2d_NCHWc_global_let)[cse_var_14] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 48)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_12)]));
              }
              for (int32_t oc_block_c_13 = 0; oc_block_c_13 < 4; ++oc_block_c_13) {
                int32_t cse_var_15 = (oc_block_c_13 + 52);
                ((float*)conv2d_NCHWc_global_let)[cse_var_15] = (((float*)conv2d_NCHWc_global_let)[cse_var_15] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 52)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_13)]));
              }
              for (int32_t oc_block_c_14 = 0; oc_block_c_14 < 4; ++oc_block_c_14) {
                int32_t cse_var_16 = (oc_block_c_14 + 56);
                ((float*)conv2d_NCHWc_global_let)[cse_var_16] = (((float*)conv2d_NCHWc_global_let)[cse_var_16] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 56)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_14)]));
              }
              for (int32_t oc_block_c_15 = 0; oc_block_c_15 < 4; ++oc_block_c_15) {
                int32_t cse_var_17 = (oc_block_c_15 + 60);
                ((float*)conv2d_NCHWc_global_let)[cse_var_17] = (((float*)conv2d_NCHWc_global_let)[cse_var_17] + (((float*)data_pad_let)[(((((((ic_outer * 4624) + (kh * 136)) + ((ax0_ax1_fused_ax2_fused & 31) * 136)) + (ow_outer * 64)) + (kw * 4)) + ic_inner) + 60)] * ((float*)fused_constant_1_let)[(((((((ax0_ax1_fused_ax2_fused >> 5) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_15)]));
              }
            }
          }
        }
    ...
    for (int32_t ax3_outer = 0; ax3_outer < 2; ++ax3_outer) {
      for (int32_t ax3_inner = 0; ax3_inner < 16; ++ax3_inner) {
        for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
          ...
          int32_t cse_var_19 = (ax3_inner * 4);
          float v_ = ((float*)conv2d_NCHWc_let)[((cse_var_20 + cse_var_19) + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_1_let)[(((ax0_ax1_fused_ax2_fused >> 5) * 4) + ax4)];
...
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_nn_relu_2(float* p0, float* T_relu, uint8_t* global_const_workspace_10_var, uint8_t* global_workspace_11_var) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused = 0; ax0_ax1_fused_ax2_fused < 128; ++ax0_ax1_fused_ax2_fused) {
    ...
    for (int32_t ic_outer = 0; ic_outer < 4; ++ic_outer) {
      for (int32_t kh = 0; kh < 3; ++kh) {
        for (int32_t kw = 0; kw < 3; ++kw) {
          for (int32_t ic_inner = 0; ic_inner < 4; ++ic_inner) {
            for (int32_t oc_block_c = 0; oc_block_c < 4; ++oc_block_c) {
              ((float*)conv2d_NCHWc_global_let)[oc_block_c] = (((float*)conv2d_NCHWc_global_let)[oc_block_c] + (((float*)data_pad_let)[(((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c)]));
            }
            for (int32_t oc_block_c_1 = 0; oc_block_c_1 < 4; ++oc_block_c_1) {
              int32_t cse_var_3 = (oc_block_c_1 + 4);
              ((float*)conv2d_NCHWc_global_let)[cse_var_3] = (((float*)conv2d_NCHWc_global_let)[cse_var_3] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 8)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_1)]));
            }
            for (int32_t oc_block_c_2 = 0; oc_block_c_2 < 4; ++oc_block_c_2) {
              int32_t cse_var_4 = (oc_block_c_2 + 8);
              ((float*)conv2d_NCHWc_global_let)[cse_var_4] = (((float*)conv2d_NCHWc_global_let)[cse_var_4] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 16)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_2)]));
            }
            for (int32_t oc_block_c_3 = 0; oc_block_c_3 < 4; ++oc_block_c_3) {
              int32_t cse_var_5 = (oc_block_c_3 + 12);
              ((float*)conv2d_NCHWc_global_let)[cse_var_5] = (((float*)conv2d_NCHWc_global_let)[cse_var_5] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 24)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_3)]));
            }
            for (int32_t oc_block_c_4 = 0; oc_block_c_4 < 4; ++oc_block_c_4) {
              int32_t cse_var_6 = (oc_block_c_4 + 16);
              ((float*)conv2d_NCHWc_global_let)[cse_var_6] = (((float*)conv2d_NCHWc_global_let)[cse_var_6] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 32)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_4)]));
            }
            for (int32_t oc_block_c_5 = 0; oc_block_c_5 < 4; ++oc_block_c_5) {
              int32_t cse_var_7 = (oc_block_c_5 + 20);
              ((float*)conv2d_NCHWc_global_let)[cse_var_7] = (((float*)conv2d_NCHWc_global_let)[cse_var_7] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 40)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_5)]));
            }
            for (int32_t oc_block_c_6 = 0; oc_block_c_6 < 4; ++oc_block_c_6) {
              int32_t cse_var_8 = (oc_block_c_6 + 24);
              ((float*)conv2d_NCHWc_global_let)[cse_var_8] = (((float*)conv2d_NCHWc_global_let)[cse_var_8] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 48)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_6)]));
            }
            for (int32_t oc_block_c_7 = 0; oc_block_c_7 < 4; ++oc_block_c_7) {
              int32_t cse_var_9 = (oc_block_c_7 + 28);
              ((float*)conv2d_NCHWc_global_let)[cse_var_9] = (((float*)conv2d_NCHWc_global_let)[cse_var_9] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 56)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_7)]));
            }
            for (int32_t oc_block_c_8 = 0; oc_block_c_8 < 4; ++oc_block_c_8) {
              int32_t cse_var_10 = (oc_block_c_8 + 32);
              ((float*)conv2d_NCHWc_global_let)[cse_var_10] = (((float*)conv2d_NCHWc_global_let)[cse_var_10] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 64)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_8)]));
            }
            for (int32_t oc_block_c_9 = 0; oc_block_c_9 < 4; ++oc_block_c_9) {
              int32_t cse_var_11 = (oc_block_c_9 + 36);
              ((float*)conv2d_NCHWc_global_let)[cse_var_11] = (((float*)conv2d_NCHWc_global_let)[cse_var_11] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 72)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_9)]));
            }
            for (int32_t oc_block_c_10 = 0; oc_block_c_10 < 4; ++oc_block_c_10) {
              int32_t cse_var_12 = (oc_block_c_10 + 40);
              ((float*)conv2d_NCHWc_global_let)[cse_var_12] = (((float*)conv2d_NCHWc_global_let)[cse_var_12] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 80)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_10)]));
            }
            for (int32_t oc_block_c_11 = 0; oc_block_c_11 < 4; ++oc_block_c_11) {
              int32_t cse_var_13 = (oc_block_c_11 + 44);
              ((float*)conv2d_NCHWc_global_let)[cse_var_13] = (((float*)conv2d_NCHWc_global_let)[cse_var_13] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 88)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_11)]));
            }
            for (int32_t oc_block_c_12 = 0; oc_block_c_12 < 4; ++oc_block_c_12) {
              int32_t cse_var_14 = (oc_block_c_12 + 48);
              ((float*)conv2d_NCHWc_global_let)[cse_var_14] = (((float*)conv2d_NCHWc_global_let)[cse_var_14] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 96)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_12)]));
            }
            for (int32_t oc_block_c_13 = 0; oc_block_c_13 < 4; ++oc_block_c_13) {
              int32_t cse_var_15 = (oc_block_c_13 + 52);
              ((float*)conv2d_NCHWc_global_let)[cse_var_15] = (((float*)conv2d_NCHWc_global_let)[cse_var_15] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 104)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_13)]));
            }
            for (int32_t oc_block_c_14 = 0; oc_block_c_14 < 4; ++oc_block_c_14) {
              int32_t cse_var_16 = (oc_block_c_14 + 56);
              ((float*)conv2d_NCHWc_global_let)[cse_var_16] = (((float*)conv2d_NCHWc_global_let)[cse_var_16] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 112)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_14)]));
            }
            for (int32_t oc_block_c_15 = 0; oc_block_c_15 < 4; ++oc_block_c_15) {
              int32_t cse_var_17 = (oc_block_c_15 + 60);
              ((float*)conv2d_NCHWc_global_let)[cse_var_17] = (((float*)conv2d_NCHWc_global_let)[cse_var_17] + (((float*)data_pad_let)[((((((ic_outer * 4356) + ((ax0_ax1_fused_ax2_fused & 15) * 264)) + (kh * 132)) + (kw * 4)) + ic_inner) + 120)] * ((float*)fused_constant_3_let)[(((((((ax0_ax1_fused_ax2_fused >> 4) * 576) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_15)]));
            }
          }
        }
      }
    ...
    for (int32_t ax3_inner = 0; ax3_inner < 16; ++ax3_inner) {
      for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
        int32_t cse_var_19 = (ax3_inner * 4);
        float v_ = ((float*)conv2d_NCHWc_let)[(cse_var_19 + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_3_let)[(((ax0_ax1_fused_ax2_fused >> 4) * 4) + ax4)];
        T_relu[(((ax0_ax1_fused_ax2_fused * 64) + cse_var_19) + ax4)] = ((v_) > (0.000000e+00f) ? (v_) : (0.000000e+00f));
      }
    }
  }
  return 0;
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_nn_relu_3(float* p0, float* T_relu, uint8_t* global_const_workspace_16_var, uint8_t* global_workspace_17_var) {
  ...
  for (int32_t ax0_ax1_fused_ax2_fused = 0; ax0_ax1_fused_ax2_fused < 128; ++ax0_ax1_fused_ax2_fused) {
    ...
    for (int32_t ic_outer = 0; ic_outer < 8; ++ic_outer) {
      for (int32_t kh = 0; kh < 3; ++kh) {
        for (int32_t kw = 0; kw < 3; ++kw) {
          for (int32_t ic_inner = 0; ic_inner < 4; ++ic_inner) {
            for (int32_t oc_block_c = 0; oc_block_c < 4; ++oc_block_c) {
              ((float*)conv2d_NCHWc_global_let)[oc_block_c] = (((float*)conv2d_NCHWc_global_let)[oc_block_c] + (((float*)data_pad_let)[(((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c)]));
            }
            for (int32_t oc_block_c_1 = 0; oc_block_c_1 < 4; ++oc_block_c_1) {
              int32_t cse_var_3 = (oc_block_c_1 + 4);
              ((float*)conv2d_NCHWc_global_let)[cse_var_3] = (((float*)conv2d_NCHWc_global_let)[cse_var_3] + (((float*)data_pad_let)[((((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner) + 8)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_1)]));
            }
            for (int32_t oc_block_c_2 = 0; oc_block_c_2 < 4; ++oc_block_c_2) {
              int32_t cse_var_4 = (oc_block_c_2 + 8);
              ((float*)conv2d_NCHWc_global_let)[cse_var_4] = (((float*)conv2d_NCHWc_global_let)[cse_var_4] + (((float*)data_pad_let)[((((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner) + 16)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_2)]));
            }
            for (int32_t oc_block_c_3 = 0; oc_block_c_3 < 4; ++oc_block_c_3) {
              int32_t cse_var_5 = (oc_block_c_3 + 12);
              ((float*)conv2d_NCHWc_global_let)[cse_var_5] = (((float*)conv2d_NCHWc_global_let)[cse_var_5] + (((float*)data_pad_let)[((((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner) + 24)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_3)]));
            }
            for (int32_t oc_block_c_4 = 0; oc_block_c_4 < 4; ++oc_block_c_4) {
              int32_t cse_var_6 = (oc_block_c_4 + 16);
              ((float*)conv2d_NCHWc_global_let)[cse_var_6] = (((float*)conv2d_NCHWc_global_let)[cse_var_6] + (((float*)data_pad_let)[((((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner) + 32)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_4)]));
            }
            for (int32_t oc_block_c_5 = 0; oc_block_c_5 < 4; ++oc_block_c_5) {
              int32_t cse_var_7 = (oc_block_c_5 + 20);
              ((float*)conv2d_NCHWc_global_let)[cse_var_7] = (((float*)conv2d_NCHWc_global_let)[cse_var_7] + (((float*)data_pad_let)[((((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner) + 40)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_5)]));
            }
            for (int32_t oc_block_c_6 = 0; oc_block_c_6 < 4; ++oc_block_c_6) {
              int32_t cse_var_8 = (oc_block_c_6 + 24);
              ((float*)conv2d_NCHWc_global_let)[cse_var_8] = (((float*)conv2d_NCHWc_global_let)[cse_var_8] + (((float*)data_pad_let)[((((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner) + 48)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_6)]));
            }
            for (int32_t oc_block_c_7 = 0; oc_block_c_7 < 4; ++oc_block_c_7) {
              int32_t cse_var_9 = (oc_block_c_7 + 28);
              ((float*)conv2d_NCHWc_global_let)[cse_var_9] = (((float*)conv2d_NCHWc_global_let)[cse_var_9] + (((float*)data_pad_let)[((((((ic_outer * 1156) + ((ax0_ax1_fused_ax2_fused & 7) * 136)) + (kh * 68)) + (kw * 4)) + ic_inner) + 56)] * ((float*)fused_constant_6_let)[(((((((ax0_ax1_fused_ax2_fused >> 3) * 1152) + (ic_outer * 144)) + (kh * 48)) + (kw * 16)) + (ic_inner * 4)) + oc_block_c_7)]));
            }
          }
        }
      }
    ...
    for (int32_t ax3_inner = 0; ax3_inner < 8; ++ax3_inner) {
      for (int32_t ax4 = 0; ax4 < 4; ++ax4) {
        int32_t cse_var_11 = (ax3_inner * 4);
        float v_ = ((float*)conv2d_NCHWc_let)[(cse_var_11 + ax4)] + ((float*)fused_nn_contrib_conv2d_NCHWc_constant_6_let)[(((ax0_ax1_fused_ax2_fused >> 3) * 4) + ax4)];
        T_relu[(((ax0_ax1_fused_ax2_fused * 32) + cse_var_11) + ax4)] = ((v_) > (0.000000e+00f) ? (v_) : (0.000000e+00f));
      }
    }
  }
  return 0;
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_contrib_dense_pack_add(float* p0, float* T_add, uint8_t* global_const_workspace_28_var, uint8_t* global_workspace_29_var) {
...
TVM_DLL int32_t tvmgen_default___tvm_main__(float* input_1_buffer_var, float* output_buffer_var, uint8_t* global_const_workspace_0_var, uint8_t* global_workspace_1_var) {
  ...
  if (tvmgen_default_fused_transpose_layout_transform(input_1_buffer_var, sid_1_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  ...
  if (tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_add_nn_relu(sid_3_let, sid_2_let, sid_4_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_nn_relu_2(sid_4_let, sid_5_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add(sid_5_let, sid_6_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_add_nn_relu_1(sid_4_let, sid_6_let, sid_7_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_nn_relu_3(sid_7_let, sid_8_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  ...
  if (tvmgen_default_fused_nn_contrib_conv2d_NCHWc_add_add_nn_relu_2(sid_7_let, sid_9_let, sid_10_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  ...
  if (tvmgen_default_fused_nn_avg_pool2d(sid_11_let, sid_12_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_layout_transform_reshape(sid_12_let, sid_13_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
  if (tvmgen_default_fused_nn_contrib_dense_pack_add(sid_13_let, sid_14_let, global_const_workspace_0_var, global_workspace_1_var) != 0 ) return -1;
